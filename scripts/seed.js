...
const tours = [
  ...
  // Tokio (tokyo)
  { title: 'Tour de Sushi en Tsukiji', description: 'Recorrido por el mercado de pescado más grande del mundo con degustación de sushi fresco preparado por chefs locales.', price: 129.99, imageUrl: 'https://picsum.photos/seed/tsukiji/400/300', destinationId: 'tokyo', destinationName: 'Tokio', categories: ['comida'], durationDays: 1, capacity: 12, availableSpots: 6, averageRating: 4.7, reviewCount: 156, isActive: true, createdAt: ts('2024-01-21') },
  { title: 'Visita a templos antiguos', description: 'Recorrido por los templos más emblemáticos de Tokio: Senso-ji, Meiji y el templo de la Roca que Escucha.', price: 69.99, imageUrl: 'https://picsum.photos/seed/templos/400/300', destinationId: 'tokyo', destinationName: 'Tokio', categories: ['templos', 'historia'], durationDays: 1, capacity: 20, availableSpots: 14, averageRating: 4.5, reviewCount: 198, isActive: true, createdAt: ts('2024-01-22') },
  { title: 'Experiencia en Akihabara', description: 'Sumérgete en el distrito electrónico de Akihabara. Visita tiendas de anime, videojuegos y tecnología de punta.', price: 59.99, imageUrl: 'https://picsum.photos/seed/akihabara/400/300', destinationId: 'tokyo', destinationName: 'Tokio', categories: ['cultura'], durationDays: 1, capacity: 15, availableSpots: 10, averageRating: 4.4, reviewCount: 134, isActive: true, createdAt: ts('2024-01-23') },

  // Nueva York (new_york)
  { title: 'Tour por Manhattan', description: 'Recorrido completo por Manhattan: Times Square, Central Park, Rockefeller Center y el distrito financiero.', price: 79.99, imageUrl: 'https://picsum.photos/seed/manhattan/400/300', destinationId: 'new_york', destinationName: 'Nueva York', categories: ['cultura', 'historia'], durationDays: 1, capacity: 30, availableSpots: 18, averageRating: 4.6, reviewCount: 276, isActive: true, createdAt: ts('2024-02-02') },
  { title: 'Espectáculo en Broadway', description: 'Disfruta de un musical de clase mundial en Broadway con entradas incluidas y visita detrás de escena.', price: 149.99, imageUrl: 'https://picsum.photos/seed/broadway/400/300', destinationId: 'new_york', destinationName: 'Nueva York', categories: ['cultura'], durationDays: 1, capacity: 20, availableSpots: 12, averageRating: 4.8, reviewCount: 215, isActive: true, createdAt: ts('2024-02-03') },
  { title: 'Estación Central y High Line', description: 'Descubre la arquitectura de Grand Central Terminal y camina por el High Line, el parque elevado más famoso de NYC.', price: 45.99, imageUrl: 'https://picsum.photos/seed/highline/400/300', destinationId: 'new_york', destinationName: 'Nueva York', categories: ['cultura', 'historia'], durationDays: 1, capacity: 25, availableSpots: 20, averageRating: 4.5, reviewCount: 167, isActive: true, createdAt: ts('2024-02-04') },

  // Roma (roma)
  { title: 'Tour por el Coliseo y Foro Romano', description: 'Acceso prioritario al Coliseo, el Foro Romano y la Colina Palatina con guía experto en historia antigua.', price: 99.99, imageUrl: 'https://picsum.photos/seed/coliseo/400/300', destinationId: 'roma', destinationName: 'Roma', categories: ['historia', 'museos'], durationDays: 1, capacity: 25, availableSpots: 13, averageRating: 4.7, reviewCount: 345, isActive: true, createdAt: ts('2024-02-11') },
  { title: 'Visita al Vaticano', description: 'Recorrido por los Museos Vaticanos, la Capilla Sixtina y la Basílica de San Pedro con entrada preferencial.', price: 119.99, imageUrl: 'https://picsum.photos/seed/vaticano/400/300', destinationId: 'roma', destinationName: 'Roma', categories: ['museos', 'templos', 'historia'], durationDays: 1, capacity: 20, availableSpots: 11, averageRating: 4.9, reviewCount: 421, isActive: true, createdAt: ts('2024-02-12') },
  { title: 'Clase de pasta italiana', description: 'Aprende a hacer pasta fresca con una nonna italiana. Incluye ingredientes, vino y la degustación de tu creación.', price: 89.99, imageUrl: 'https://picsum.photos/seed/pasta/400/300', destinationId: 'roma', destinationName: 'Roma', categories: ['comida', 'cultura'], durationDays: 1, capacity: 10, availableSpots: 7, averageRating: 4.8, reviewCount: 189, isActive: true, createdAt: ts('2024-02-13') },

  // Londres (london)
  { title: 'Tour por el Big Ben y Westminster', description: 'Visita guiada por el Parlamento, el Big Ben y la Abadía de Westminster. Historia viva de Londres.', price: 69.99, imageUrl: 'https://picsum.photos/seed/bigben/400/300', destinationId: 'london', destinationName: 'Londres', categories: ['historia', 'museos'], durationDays: 1, capacity: 30, availableSpots: 21, averageRating: 4.5, reviewCount: 245, isActive: true, createdAt: ts('2024-02-16') },
  { title: 'London Eye y River Thames', description: 'Disfruta de una vista panorámica de Londres desde el London Eye y un paseo en barco por el Támesis.', price: 89.99, imageUrl: 'https://picsum.photos/seed/londoneye/400/300', destinationId: 'london', destinationName: 'Londres', categories: ['cultura', 'agua'], durationDays: 1, capacity: 35, availableSpots: 25, averageRating: 4.6, reviewCount: 198, isActive: true, createdAt: ts('2024-02-17') },
  { title: 'Museo Británico', description: 'Recorrido por las colecciones más importantes del Museo Británico con guía especializado. La piedra de Rosetta incluida.', price: 39.99, imageUrl: 'https://picsum.photos/seed/museobritanico/400/300', destinationId: 'london', destinationName: 'Londres', categories: ['museos', 'historia'], durationDays: 1, capacity: 20, availableSpots: 16, averageRating: 4.4, reviewCount: 276, isActive: true, createdAt: ts('2024-02-18') },
